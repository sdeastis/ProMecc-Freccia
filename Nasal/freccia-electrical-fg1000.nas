...
io.load_nasal(aircraft_dir ~ '/Nasal/Interfaces/FrecciaInterfaceController.nas', "fg1000");
io.include("Aircraft/Generic/updateloop.nas");

var interfaceController = fg1000.FrecciaInterfaceController.getOrCreateInstance();
interfaceController.start();

io.load_nasal(aircraft_dir ~ '/Nasal/Interfaces/EIS/EIS-Freccia.nas', "fg1000");
io.load_nasal(aircraft_dir ~ '/Nasal/Interfaces/EIS/EISController.nas', "fg1000");
io.load_nasal(aircraft_dir ~ '/Nasal/Interfaces/EIS/EISStyles.nas', "fg1000");
io.load_nasal(aircraft_dir ~ '/Nasal/Interfaces/EIS/EISOptions.nas', "fg1000");
var EIS_Class = fg1000.EISFreccia;

# Create the FG1000 using custom EIS
var fg1000system = fg1000.FG1000.getOrCreateInstance(EIS_Class:EIS_Class, EIS_SVG: "Nasal/Interfaces/EIS/EIS-Freccia.svg");
