...
io.load_nasal(aircraft_dir ~ '/Nasal/Interfaces/FrecciaEISPublisher.nas', "fg1000");
...
var FrecciaInterfaceController = {
  ...
  getOrCreateInstance : func() {
    if (FrecciaInterfaceController._instance == nil) {
      FrecciaInterfaceController._instance = FrecciaInterfaceController.new();
    }

    return FrecciaInterfaceController._instance;
  },

  new : func() {
    var obj = {
      parents : [FrecciaInterfaceController],
      running : 0,
    };
  ...
  start : func() {
    ...
    foreach (var interface; FrecciaInterfaceController.INTERFACE_LIST) {
